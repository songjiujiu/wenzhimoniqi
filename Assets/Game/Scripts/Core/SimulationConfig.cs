...
namespace Mosquito.Core
{
    ...
    public sealed class SimulationConfig
    {
        ...
        public int initialLayTicks = 40, layIntervalTicks = 40, firstLayTicks = 40;
        public int hatchTicks = 20, burstTicks = 20, smallBatchLimit = 1024;
        ...
        public void Validate()
        {
            ...
            if (tickMs != 50 || startMale != 2 || startFemale != 2 ||
                !(legacyPacing || currentPacing) || smallBatchLimit != 1024 ||
